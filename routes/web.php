...
{  
	...
	Route::get('/finish-survey','MitraController@finishSurvey')->name('finish-survey');
});
...
{  
	...
	Route::get('/detail-pemesan/{id}','OperasionalController@detailPemesan')->name('detail-pemesan');
	Route::get('/selesai-survey/{id}','OperasionalController@selesaiSurvey')->name('selesai-survey');
});
